/**
 * kilroy.starter.agent/viewer_agent/suspend_hook.js - preflight/postflight functions for kilroy.starter.agent/viewer_agent/suspend_hook
 * @module kilroy.starter.agent/viewer_agent/suspend_hook
 * @file kilroy.starter.agent/viewer_agent/suspend_hook preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.starter.agent/viewer_agent/suspend_hook";
