/**
 * kilroy.starter.agent/manager/ui_make_pipeline_json.js - preflight/postflight functions for kilroy.starter.agent/manager/ui_make_pipeline_json
 * @module kilroy.starter.agent/manager/ui_make_pipeline_json
 * @file kilroy.starter.agent/manager/ui_make_pipeline_json preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.starter.agent/manager/ui_make_pipeline_json";
