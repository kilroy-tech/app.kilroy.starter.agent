/**
 * kilroy.starter.agent/manager/ui_get_agent_config.js - preflight/postflight functions for kilroy.starter.agent/manager/ui_get_agent_config
 * @module kilroy.starter.agent/manager/ui_get_agent_config
 * @file kilroy.starter.agent/manager/ui_get_agent_config preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.starter.agent/manager/ui_get_agent_config";
