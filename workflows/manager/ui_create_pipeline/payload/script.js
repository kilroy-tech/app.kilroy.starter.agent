/**
 * kilroy.starter.agent/manager/ui_create_pipeline.js - preflight/postflight functions for kilroy.starter.agent/manager/ui_create_pipeline
 * @module kilroy.starter.agent/manager/ui_create_pipeline
 * @file kilroy.starter.agent/manager/ui_create_pipeline preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.starter.agent/manager/ui_create_pipeline";
