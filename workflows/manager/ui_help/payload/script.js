/**
 * kilroy.starter.agent/manager/ui_help.js - preflight/postflight functions for kilroy.starter.agent/manager/ui_help
 * @module kilroy.starter.agent/manager/ui_help
 * @file kilroy.starter.agent/manager/ui_help preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.starter.agent/manager/ui_help";
